...
df_random = pd.read_csv('DRLvsRandom100x1000.csv')
df_civilian = pd.read_csv('DRLvsCivilian100x1000.csv')
df_military = pd.read_csv('DRLvsMilitary100x1000.csv')
df_scientific = pd.read_csv('DRLvsScientific100x1000.csv')
df_rulebased = pd.read_csv('DRLvsRuleBased100x1000.csv')

df_noMask = pd.read_csv('DRLvsNoMask100x1000.csv')
df_noMaskOrTuning = pd.read_csv('DRLvsNoMaskOrTuning100x1000.csv')
df_noTuning = pd.read_csv('DRLvsNoTuning100x1000.csv')
